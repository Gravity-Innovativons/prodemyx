  ...
  "node_modules/circletype/dist/circletype.min.js"(exports, module) {
    !function(t, e) {
      ...
      return function(t) {
        ...
        })("versions", []).push({ version: r.version, mode: n(15) ? "pure" : "global", copyright: "© 2018 Denis Pushkarev (zloirock.ru)" });
      }, function(t, e) {
        ...
        t.exports = function(t2, e2, n2, d, v, y, _) {
          ...
          if (T && (x = s(T.call(new t2()))) !== Object.prototype && x.next && (a(x, O, true), r || "function" == typeof x[l] || u(x, l, h)), w && S && "values" !== S.name && (j = true, P = function() {
            return S.call(this);
          }), r && !_ || !p && !j && M[l] || u(M, l, P), c[e2] = P, c[O] = h, v) if (m = { values: w ? P : b("values"), keys: y ? P : b("keys"), entries: A }, _) for (g in m) g in M || o(M, g, m[g]);
